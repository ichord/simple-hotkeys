...
Hotkeys = (function(_super) {
  ...
  Hotkeys.prototype.bind = function(keyid, handler) {
    this.handlers[this.constructor.normalize(keyid)] = handler;
    return this;
  };

  Hotkeys.prototype.unbind = function(keyid) {
